        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center p-4 w-60 hover:cursor-pointer"
                    ...
                    <Image src={"/images/Qlogo.png"} alt="Quirky.ai" width="250" height="100"/>
                        <h1 className="text-lg font-normal text-center text-gray-700">Experimental </h1>
                        <h1 className="text-lg font-semibold text-center text-gray-700">GPT-4 <i
                            className="fas fa-arrow-right text-primary"/> Project </h1>
